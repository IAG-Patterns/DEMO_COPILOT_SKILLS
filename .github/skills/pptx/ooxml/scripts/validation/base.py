...
def _ns(uri: str) -> str:
    """Return an XML namespace URI.

    Note: Many XML namespace identifiers are defined by standards as `http`-scheme URIs.
    They are identifiers (not fetched over the network), but some security scanners flag
    literal scheme+separator strings. Build them without embedding that literal sequence.
    """
...
class BaseSchemaValidator:
    ...
    MC_NAMESPACE = _ns("schemas.openxmlformats.org/markup-compatibility/2006")
    XML_NAMESPACE = _ns("www.w3.org/XML/1998/namespace")

    # Common OOXML namespaces used across validators
    PACKAGE_RELATIONSHIPS_NAMESPACE = (
        _ns("schemas.openxmlformats.org/package/2006/relationships")
    )
    OFFICE_RELATIONSHIPS_NAMESPACE = (
        _ns("schemas.openxmlformats.org/officeDocument/2006/relationships")
    )
    CONTENT_TYPES_NAMESPACE = (
        _ns("schemas.openxmlformats.org/package/2006/content-types")
    )
    ...
    OOXML_NAMESPACES = {
        _ns("schemas.openxmlformats.org/officeDocument/2006/math"),
        _ns("schemas.openxmlformats.org/officeDocument/2006/relationships"),
        _ns("schemas.openxmlformats.org/schemaLibrary/2006/main"),
        _ns("schemas.openxmlformats.org/drawingml/2006/main"),
        _ns("schemas.openxmlformats.org/drawingml/2006/chart"),
        _ns("schemas.openxmlformats.org/drawingml/2006/chartDrawing"),
        _ns("schemas.openxmlformats.org/drawingml/2006/diagram"),
        _ns("schemas.openxmlformats.org/drawingml/2006/picture"),
        _ns("schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing"),
        _ns("schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing"),
        _ns("schemas.openxmlformats.org/wordprocessingml/2006/main"),
        _ns("schemas.openxmlformats.org/presentationml/2006/main"),
        _ns("schemas.openxmlformats.org/spreadsheetml/2006/main"),
        _ns("schemas.openxmlformats.org/officeDocument/2006/sharedTypes"),
        _ns("www.w3.org/XML/1998/namespace"),
    }
